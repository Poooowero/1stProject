...
Book::Book(unsigned short releaseYear, unsigned short numberOfPages, unsigned int basePrice, float usersRating,
           ...
           const std::string &reservedBy, unsigned int bookId) : releaseYear(releaseYear), numberOfPages(numberOfPages),
                                            ...
                                            addedBy(addedBy), reservedBy(reservedBy), bookId(bookId) {}
